...
//mod solutions;
//use solutions::solutions::{process_first, process_second, process_second_cb, process_second_cb_rayon};

//use crate::solutions::solutions::*;
// use rayon::prelude::*;
use std::fs;
mod solutions;
use crate::solutions::solutions::{process_first, process_second, process_second_cb, process_second_cb_rayon};
// use crate::solutions::solutions::{process_first, process_second, process_second_cb, process_second_cb_rayon};
